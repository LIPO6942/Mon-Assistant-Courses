                                ...
                                <div className="absolute inset-0 bg-background/95 backdrop-blur-sm flex flex-col items-center justify-center p-6 text-center animate-in fade-in zoom-in duration-200">
                                    ...
                                    <div className="flex flex-col w-full gap-2 px-2">
                                        <div className="flex gap-2 w-full">
                                            ...
                                            {notifyingRecipient.messenger && (
                                                <Button
                                                    ...
                                                    variant="secondary"
                                                    className="flex-1 bg-[#00B2FF] hover:bg-[#0099FF] text-white rounded-xl gap-2 h-10 text-xs px-2"
                                                >
                                                    <svg className="h-4 w-4 fill-current shrink-0" viewBox="0 0 24 24"><path d="M12 0C5.373 0 0 4.974 0 11.111c0 3.498 1.744 6.614 4.469 8.654V24l4.088-2.242c1.092.304 2.246.464 3.443.464 6.627 0 12-4.974 12-11.111C24 4.974 18.627 0 12 0zm1.258 14.946l-3.072-3.277-5.983 3.277 6.573-6.975 3.197 3.277 5.858-3.277-6.573 6.975z" /></svg>
                                                    Messenger
                                                </Button>
                                            )}
                                        </div>
                                        <Button
                                            ...
                                            className="w-full rounded-xl mt-1 text-muted-foreground"
                                        >
                                            Plus tard
                                        </Button>
                                    </div>
