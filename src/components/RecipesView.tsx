...
export default function RecipesView({
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className='text-2xl font-bold mb-4'>Découvrir des Recettes du Monde</h2>
            ...
            <Card key={recipe.id} className="overflow-hidden flex flex-col">
              ...
              <CardFooter className="flex justify-between mt-auto bg-secondary/30 pt-4">
                ...
                >
                  ...
                  {savedRecipeIds.has(recipe.id) ? 'Sauvegardée' : 'Sauvegarder'}
                </Button>
              </CardFooter>
            </Card>
          ))}
      ...
      <div>
        ...
        {savedRecipes.length > 0 ? (
          ...
          <div className="text-center py-10 border-2 border-dashed rounded-lg">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Cliquez sur "Sauvegarder" sur une recette ci-dessus pour l'ajouter ici.</p>
          </div>
        )}
      </div>
    </div>
