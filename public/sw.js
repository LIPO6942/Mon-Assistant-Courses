const CACHE_NAME = 'mac-master-v4'; // Incrémenté pour forcer la mise à jour du SW
...
// Workbox est chargé depuis un CDN externe. On le protège dans un try-catch :
// si le CDN est inaccessible, le reste du Service Worker (FCM, notifications, cache)
...
try {
  ...
  console.warn('[sw.js] Workbox non disponible, Background Sync désactivé:', e);
}
